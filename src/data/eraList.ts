...
export const ERA_LIST: readonly EraData[] = [
  ...
  },
  {
    id: 'early-web',
    shortYear: '1993–1996',
    title: 'Browsers & Personal Pages',
    subtitle: 'Mosaic, Netscape, GeoCities, and the Wild Web',
    themeClass: 'theme-web90',
    speculative: false,
  },
  {
  ...
  },
  {
    ...
    subtitle: 'Fiber, undersea cables, data centers, and satellites',
  ...
  },
  {
    ...
    shortYear: '2023–',
    title: 'The AI Era',
    subtitle: 'Networks that learn, at planetary scale',
    themeClass: 'theme-modern',
    speculative: false,
  },
  {
